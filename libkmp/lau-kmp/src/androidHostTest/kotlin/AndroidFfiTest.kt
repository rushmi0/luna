...
class AndroidFfiTest {
    ...
    @Test
    fun android_exec_returns_true_on_success() {
        makeVm().use { vm ->
            val ok = vm.exec("x = 1")
            assertTrue(ok)
        }
    ...
    @Test
    fun android_run_returns_boolean_true() {
        makeVm().use { vm ->
    ...
    @Test
    fun android_run_returns_boolean_false() {
        makeVm().use { vm ->
    ...
    @Test
    fun android_run_returns_integer() {
        makeVm().use { vm ->
    ...
    @Test
    fun android_run_returns_number() {
        makeVm().use { vm ->
    ...
    @Test
    fun android_run_returns_string() {
        makeVm().use { vm ->
    ...
    @Test
    fun android_set_get_global_nil() {
        makeVm().use { vm ->
    ...
    @Test
    fun android_set_get_global_boolean() {
        makeVm().use { vm ->
    ...
    @Test
    fun android_set_get_global_number() {
        makeVm().use { vm ->
    ...
    @Test
    fun android_set_get_global_string() {
        makeVm().use { vm ->
    ...
    @Test
    fun android_all_stdlib_has_debug() {
        makeVm().use { vm ->
    ...
    @Test
    fun android_syntax_error_throws_Syntax() {
        makeVm().use { vm ->
    ...
    @Test
    fun android_runtime_error_throws_Runtime() {
        makeVm().use { vm ->
    ...
    @Test
    fun android_lua54_integer_division() {
        makeVm().use { vm ->
